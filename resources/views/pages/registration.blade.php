      ...
      <div class="col-12 col-md-8 col-lg-6 col-xl-5">
        <div class="card shadow-2-strong" style="border-radius: 1rem;">
          <div class="card-body p-5 text-center">
            ...
            <form action="{{route('registration.form.post')}}"method="post">
            @csrf

            <div class="form-outline mb-4">
              <input required name="name" type="text" id="typeNameX-2" class="form-control form-control-lg" />
            ...
            <div class="form-outline mb-4">
              <input required name="phone" type="phone" id="typePhoneX-2" class="form-control form-control-lg" />
